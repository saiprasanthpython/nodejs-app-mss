...
*/
app.get('/sidhudevops', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to  sidhudevopswebsite. Please Contact +91-7619632475 for more information or send an email to saiprasanthpython@gmail.com <center></h2>" );
    response.end();
